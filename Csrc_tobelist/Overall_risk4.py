...
class Overall_4(object):
    ...
    def risk_4(self):
        ...
        try:
            if txt4 == ('衡量公司舆情的负面程度，负面舆情越多，爆发的时间越近，风险值越高。'):
                print('负面舆情监测的 旧文案为：%s'%(txt4))
            elif txt4 == '衡量公司舆情的负面程度，负面舆情越多，爆发的时间越近，风险值越高。':
                print('负面舆情监测的 新文案为：%s'%('衡量公司舆情的负面程度，负面舆情越多，爆发的时间越近，风险值越高。'))
            else:
