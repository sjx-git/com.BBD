...
class Overall_1(object):
    ...
    def risk_1(self):
        ...
        WebDriverWait(self.driver1,10,1).until(lambda x:self.driver1.find_element_by_xpath('//*[@id="anchor-classifyOverview"]/div[2]/button[1]/a'))#进入交易对手风险
        ...
        #print('1')
        WebDriverWait(self.driver1,50,0.5).until(lambda x:self.driver1.find_element_by_xpath('//*[@id="rigthContent"]/div/div/div/div[3]/div/div[2]/div/div/div/div[2]/div'))#暂时不明白如何取出text()中的内容，只能全部取出后，用正则提取
        #print('2')
        tx = self.driver1.find_element_by_xpath('//*[@id="rigthContent"]/div/div/div/div[3]/div/div[2]/div/div/div/div[2]/div').text#print(tx)
