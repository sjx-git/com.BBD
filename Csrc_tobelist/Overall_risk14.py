...
class Overall_14(object):
    ...
    def risk_14(self):
        ...
        try:
            ...
            name14_1 = self.driver1.find_element_by_xpath('//*[@id="rigthContent"]/div/div/div/div[5]/div[4]/div/div/div[2]/div/div/div/div/div[1]/table/thead/tr').text
        ...
        try:
            ...
            if name14 == self.lists[35]:
                print('标题 未调整:%s'%(name14))

            elif name14 == self.lists[34]:
                print('标题 已调整:%s'%(name14))
            else:
                print('标题 调整错了:%s'%(name14))
        except:
            print('标题 调整错了:%s'%(name14))
            print(list(name14))
